	...
	private void loadSteps () {
		try {
			ArrayList<PartialView> steps = new ArrayList<PartialView> () {{
				add (new StepPartial (ViewFlipperActivity.this, R.drawable.ic_1, "Passo 1"));
				add (new StepPartial (ViewFlipperActivity.this, R.drawable.ic_2, "Olha só o passo 2"));
				add (new StepPartial (ViewFlipperActivity.this, R.drawable.ic_3, "Imagina esse passo 3"));
			}};
